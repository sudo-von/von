...
export const InvalidEmailLengthError = createDomainErrorFactory({
  ...
  error: `Please provide an email that consists of ${userRules.email.MIN_LENGTH} to ${userRules.email.MAX_LENGTH} characters.`,
});

export const InvalidNameLengthError = createDomainErrorFactory({
  code: 'INVALID_NAME_LENGTH',
  error: `Please provide a name that consists of ${userRules.name.MIN_LENGTH} to ${userRules.name.MAX_LENGTH} characters.`,
});

export const InvalidPasswordLengthError = createDomainErrorFactory({
  code: 'INVALID_PASSWORD_LENGTH',
  error: `Please provide a password that consists of ${userRules.password.MIN_LENGTH} to ${userRules.password.MAX_LENGTH} characters.`,
});

export const InvalidUsernameLengthError = createDomainErrorFactory({
  code: 'INVALID_USERNAME_LENGTH',
  error: `Please provide a username that consists of ${userRules.username.MIN_LENGTH} to ${userRules.username.MAX_LENGTH} characters.`,
});
