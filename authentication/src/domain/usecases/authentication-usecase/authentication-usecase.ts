...
abstract class AuthenticationUsecase {
  ...
  * @returns {Promise<DetailedSecureUser>} A promise with the detailed secure user after signup.
  */
  ...
  * @returns {Promise<DetailedSecureUser>} A promise with the detailed secure user after login.
  */
