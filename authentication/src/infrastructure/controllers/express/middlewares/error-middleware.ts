...
const domainErrors: Record<DomainErrorCode, ControllerErrorFactory> = {
  ...
  INVALID_AVATAR_FILE_NAME_LENGTH: InvalidProfilePictureNameLengthControllerError,
  INVALID_AVATAR_FILE_MIME_TYPE: InvalidProfilePictureMimeTypeControllerError,
  INVALID_AVATAR_FILE_SIZE: InvalidProfilePictureSizeControllerError,
